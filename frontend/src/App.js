    ...
    <Router>
      ...
      <main className="py-3">
        <Container>
          ...
          <Route path="/admin/bundlelist/:pageNumber" component={BundleListScreen} exact />
          <Route path="/admin/bundle/:id/edit" component={BundleEditScreen} />
          <Route path="/admin/subscriptionlist" component={SubscriptionListScreen} />
